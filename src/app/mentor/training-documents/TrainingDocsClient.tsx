...
import { uploadMentorResource, deleteMentorResource } from "../actions";
  ...
  return (
    <div className="max-w-6xl mx-auto">
      <div className="flex flex-wrap items-start justify-between gap-4">
        <div>
          <h1 className="text-[26px] sm:text-[30px] font-semibold">{t("mentor.training.title")}</h1>
        </div>
